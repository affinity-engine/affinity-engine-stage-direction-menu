...
export default Scene.extend({
  ...
  start: task(function * (script) {
    ...
    $hook('data').text(`key: ${menu.key}, text: ${menu.text}, input: ${menu.value}`);

    menu = yield script.menu(['A', 'B', 'C'], { text: 'foo', classNames: ['bar', 'baz'] });
  })
});
